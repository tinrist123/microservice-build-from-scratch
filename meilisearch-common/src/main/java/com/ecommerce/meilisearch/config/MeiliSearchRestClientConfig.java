...
import com.ecommerce.meilisearch.interceptor.MeiliLoggingInterceptor;
...
public class MeiliSearchRestClientConfig {
    ...
    @Bean
    public RestClient meiliSearchRestClient(MeiliSearchIntegrationConfig config, MeiliSearchHttpConfig httpConfig) {
